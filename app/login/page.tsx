      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        >
          ...
          <div className="text-center mb-5">
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center text-base font-bold mx-auto mb-3"
              style={{ background: "#0B2349", color: "#C9A227" }}
            >
              SK
            </div>
            <h1
              className="text-xl font-bold text-[#0B2349] mb-0.5"
              style={{ fontFamily: '"Baskerville", "Baskerville Old Face", "Palatino Linotype", Georgia, serif' }}
            >
              S.K. Boafo & Company
            </h1>
            <p className="text-[11px] text-[#94A3B8] tracking-wide uppercase font-medium">
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#E2E8F0] px-3 py-2 text-[13px] text-[#1e293b] outline-none focus:border-[#0B2349] transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-lg border border-[#E2E8F0] px-3 py-2 text-[13px] text-[#1e293b] outline-none focus:border-[#0B2349] transition-colors pr-10"
                  style={{ fontFamily: "Roboto, sans-serif" }}
                />
                <button
                  type="button"
          ...
          >
            <p className="text-[10px] font-semibold uppercase tracking-widest text-[#94A3B8] px-4 pt-3 pb-2">
              Demo Credentials
            </p>

            <div className="overflow-y-auto px-4 pb-3" style={{ maxHeight: "180px" }}>
              {[
                    ...
                    {users.map((u) => (
                      ...
                      >
                        <div className="flex items-center justify-between gap-2">
                          <p className="text-[12px] font-medium text-[#1e293b]">{u.name}</p>
                          <p className="text-[11px] text-[#94A3B8] font-mono truncate">{u.email}</p>
                        </div>
                      </button>
                    ))}
                  </div>
            ...
            <p className="text-[10px] text-[#C4C9D4] pb-2.5 text-center">Click any row to autofill</p>
          </div>
        </div>
